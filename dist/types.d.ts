export type PrismaScalarType = "String" | "Int" | "Float" | "Boolean" | "DateTime" | "Json" | "Decimal" | "BigInt" | "Bytes";
...
export declare const REFERENTIAL_ACTION_MAP: Record<ReferentialAction, string>;
export interface PrismaDefault {
    kind: "autoincrement" | "uuid" | "cuid" | "auto" | "now" | "dbgenerated" | "literal";
    value?: string;
}
